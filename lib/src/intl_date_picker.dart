...
import 'intl_calendar_date_picker.dart';
...
/// push [IntlDatePickerDialog] when the button is tapped.
///
/// ```dart
...
///
Future<DateTime?> showIntlDatePicker({
  ...
  String? confirmText,
  Locale? locale,
  Calendar calendarMode = Calendar.gregorian,
  ...
  Widget dialog = IntlDatePickerDialog(
...
///
/// It is used internally by [showIntlDatePicker] or can be directly pushed
/// onto the [Navigator] stack to enable state restoration. See
/// [showIntlDatePicker] for a state restoration app example.
///
/// See also:
///
///  * [showIntlDatePicker], which is a way to display the date picker.
class IntlDatePickerDialog extends StatefulWidget {
  /// A Material-style date picker dialog.
  IntlDatePickerDialog({
    Key? key,
    required DateTime initialDate,
  ...
  /// Restoration ID to save and restore the state of the [IntlDatePickerDialog].
  ///
  ...
  @override
  State<IntlDatePickerDialog> createState() => _IntlDatePickerDialogState();
}

class _IntlDatePickerDialogState extends State<IntlDatePickerDialog>
  ...
  Widget build(BuildContext context) {
    ...
    final String dateText = IntlDateUtils.formatMediumDate(
      context,
      _selectedDate.value,
      widget.calendarMode,
    );
    ...
    IntlCalendarDatePicker calendarDatePicker() {
      return IntlCalendarDatePicker(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      Expanded(
                        child: FittedBox(child: title, fit: BoxFit.scaleDown),
                      ),
...
/// This is accomplished by enabling state restoration by specifying
/// [MaterialApp.restorationScopeId] and using [Navigator.restorablePush] to
/// push [IntlDateRangePickerDialog] when the button is tapped.
///
/// ```dart
...
/// See also:
///
///  * [showIntlDatePicker], which shows a material design date picker used to
...
Future<DateTimeRange?> showJalaliDateRangePicker({
  ...
  Widget dialog = IntlDateRangePickerDialog(
...
class IntlDateRangePickerDialog extends StatefulWidget {
  /// A Material-style date range picker dialog.
  const IntlDateRangePickerDialog({
    Key? key,
  ...
  /// Restoration ID to save and restore the state of the [IntlDateRangePickerDialog].
  ///
  ...
  @override
  State<IntlDateRangePickerDialog> createState() =>
      _IntlDateRangePickerDialogState();
}

class _IntlDateRangePickerDialogState extends State<IntlDateRangePickerDialog>
    with RestorationMixin {
  late final _RestorableDatePickerEntryMode _entryMode =
      _RestorableDatePickerEntryMode(widget.initialEntryMode);
...
class _MonthItemState extends State<_MonthItem> {
  ...
  void _dayFocusChanged(bool focused) {
    if (focused) {
      final TraversalDirection? focusDirection = _FocusedDate.of(
        context,
      )?.scrollDirection;
